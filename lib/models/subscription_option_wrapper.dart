...
class SubscriptionOption extends Equatable {
      ...
      SubscriptionOption(
        ...
        json['fullPricePhase'] != null
            ? PricingPhase.fromJson(
                Map<String, dynamic>.from(json['fullPricePhase']),
              )
            : null,
        json['freePhase'] != null
            ? PricingPhase.fromJson(
                Map<String, dynamic>.from(json['freePhase']),
              )
            : null,
        json['introPhase'] != null
            ? PricingPhase.fromJson(
                Map<String, dynamic>.from(json['introPhase']),
              )
            : null,
        ...
        json['installmentsInfo'] != null
            ? InstallmentsInfo.fromJson(
                Map<String, dynamic>.from(json['installmentsInfo']),
              )
            : null,
      );
  ...
  Map<String, dynamic> toJson() => <String, dynamic>{
        ...
        'isPrepaid': isPrepaid,
        'fullPricePhase': fullPricePhase?.toJson(),
        'freePhase': freePhase?.toJson(),
        'introPhase': introPhase?.toJson(),
        'presentedOfferingContext': presentedOfferingContext?.toJson(),
        'installmentsInfo': installmentsInfo?.toJson(),
      };
