...
_$StoreProductImpl _$$StoreProductImplFromJson(Map json) => _$StoreProductImpl(
      ...
      (json['pricePerWeek'] as num?)?.toDouble(),
      (json['pricePerMonth'] as num?)?.toDouble(),
      (json['pricePerYear'] as num?)?.toDouble(),
      json['priceString'] as String,
      json['pricePerWeekString'] as String?,
      json['pricePerMonthString'] as String?,
      json['pricePerYearString'] as String?,
...
Map<String, dynamic> _$$StoreProductImplToJson(_$StoreProductImpl instance) =>
    <String, dynamic>{
      ...
      'pricePerWeekString': instance.pricePerWeekString,
      'pricePerMonthString': instance.pricePerMonthString,
      'pricePerYearString': instance.pricePerYearString,
