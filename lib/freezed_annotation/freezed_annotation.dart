...
class EqualUnmodifiableListView<T> extends UnmodifiableListView<T> {
  ...
  @override
  bool operator ==(Object other) => other is EqualUnmodifiableListView<T> &&
...
class EqualUnmodifiableSetView<T> extends UnmodifiableSetView<T> {
  ...
  @override
  bool operator ==(Object other) => other is EqualUnmodifiableSetView<T> &&
        other.runtimeType == runtimeType &&
        other._source == _source;
...
class EqualUnmodifiableMapView<Key, Value>
  ...
  @override
  bool operator ==(Object other) => other is EqualUnmodifiableMapView<Key, Value> &&
        other.runtimeType == runtimeType &&
        other._source == _source;
