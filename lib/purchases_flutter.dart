...
class Purchases {
  ...
  /// Subscriber attribute associated with the Singular Device ID (SDID) for the
  /// user. Required for the RevenueCat Singular integration when using
  /// Singular's Event Endpoint V2.
  ///
  ...
  /// Can be obtained from Amazon's PurchaseResponse > Receipt > purchaseTime.
