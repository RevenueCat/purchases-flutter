...
Pod::Spec.new do |s|
  ...
  s.dependency 'PurchasesHybridCommon', '1.4.5'
  s.ios.deployment_target = '9.0'
  s.swift_version         = '5.0'

  # Flutter.framework does not contain a i386 slice.
  s.pod_target_xcconfig = { 'DEFINES_MODULE' => 'YES', 'EXCLUDED_ARCHS[sdk=iphonesimulator*]' => 'i386', 'OTHER_LDFLAGS' => '$(inherited) -framework Purchases' }
